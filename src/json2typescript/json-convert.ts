...
export class JsonConvert {
    ...
    serializeObject<T>(instance: T): any {
        ...
        } else if (typeof (instance) !== "object" || Array.isArray(instance)) {
    ...
    serializeArray<T>(instanceArray: T[]): any[] {
        ...
        } else if (typeof (instanceArray) !== "object" || Array.isArray(instanceArray) === false) {
    ...
    deserializeObject<T>(jsonObject: any, classReference: { new(): T }): T {
        ...
        } else if (typeof (jsonObject) !== "object" || Array.isArray(jsonObject)) {
